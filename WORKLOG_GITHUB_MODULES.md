...
- Обязательное правило для floating/minimized GitHub окна: drag должен следовать за пальцем без догоняющей анимации; анимация допустима только для переходов collapse/expand, но не для самого перемещения.
- Покрыты:
